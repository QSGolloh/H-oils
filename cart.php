...
<table class="table-shopping-cart">
            ...
            <td class=\"column-1\">
                ...
                <td class=\"column-5\">$name</td>
                <form method=\"POST\">
                <input style =\"background-color: #3CBC8D;\" type=\"hidden\" value=".$pro_id." name=\"cart_id\">
	...
	<footer class="bg6 p-t-45 p-b-43 p-l-45 p-r-45">
		...
		<div class="t-center p-l-15 p-r-15">
			...
			<div class="t-center s-text8 p-t-20">
				Copyright © 2018 All rights reserved. | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by QSG
			</div>
		</div>
	</footer>
